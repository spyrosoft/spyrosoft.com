...
{
	var input_to_handle = document.getElementById('encoding-input').value;
	
	if (input_to_handle == previous_input) {
		return true;
	}
	previous_input = input_to_handle;
	
	var character_frequency_hash = populate_character_frequency_hash(input_to_handle);
	...
	document.getElementById('encoded-table').value = huffman_encoding_table.toString();
	
	huffman_encoding_table.set_character_encoding_hash();
	document.getElementById('encoded-output').value = huffman_encoding_table.encode_text(input_to_handle);
...
function encode_mode() {
	document.getElementById('decode-button-container').style.display = 'none';
	document.getElementById('encode-button-container').style.display = 'inline';
	document.getElementById('encode-mode-button').style.display = 'none';
	document.getElementById('decode-mode-button').style.display = 'inline';
	document.getElementById('decoded-output-container').style.display = 'none';
	document.getElementById('encode-output-container').style.display = 'block';
	document.getElementById('encoding-input').select();
}

function decode_mode() {
	document.getElementById('encode-button-container').style.display = 'none';
	document.getElementById('decode-button-container').style.display = 'inline';
	document.getElementById('decode-mode-button').style.display = 'none';
	document.getElementById('encode-mode-button').style.display = 'inline';
	document.getElementById('encode-output-container').style.display = 'none';
	document.getElementById('decoded-output-container').style.display = 'block';
	document.getElementById('encoded-table').select();
}
