...
%section
  %p
    %strong Basic Mac Security, Maintenance, and Usage
  %p
    Bennett Roesch
    %br
    6-7-16
    %br
    %a{:href => "https://spyrosoft.com/"} https://spyrosoft.com/
%section
  %p
...
%section
  ...
  %ul
    ...
    %li
      ...
      \: Switch Applications in reverse
    %li
      %strong Command + Tick
      \: Switch windows in the current Application
    %li
      %strong Command + Shift + Tick
      \: Switch windows in the current Application in reverse
%section
  %h1 Yellow Belt
  %p Whoa.
%section
...
%section
  ...
  %p
    %strong Chrome
  %p chrome://plugins/
  %p Remove all plugins which should not be there.
%section
...
%section
  ...
  %ul
    ...
    %li
      %strong Command + Shift + V
      \: Paste with no formatting
    %li
      %strong Alt + Green Button
      \: Maximize Window rather than Full Screen
    %li
      %strong Command + Left/Right Arrow Keys
      \: Navigate to the Beginning or the End of the current sentence
    %li
      %strong Alt + Arrow Keys
      \: Navigate forward or backward one word
%section
  %h4 Keyboard Shortcuts
  %ul
    %li
